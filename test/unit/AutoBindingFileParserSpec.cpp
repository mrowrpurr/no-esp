...
#include <ThePrototype/AutoBindingsParser.h>
#include <ThePrototype/BindingDefinition.h>

go_bandit([](){
    describe("Parsing AutoBindings lines", [](){
        it("ScriptName", [&](){
            auto def = ThePrototype::AutoBindingsFile::ParseLine("MyScript");

            AssertThat(def.ScriptName, Equals("MyScript"));
            AssertThat(def.Type, Equals(ThePrototype::BindingDefinitionType::FormID));
            AssertThat(def.FormID, Equals(20)); // The player
            AssertThat(def.EditorIdMatcher.Type, Equals(ThePrototype::EditorIdMatcherType::None));
        });
        it("ScriptName SomeEditorId (exact)", [&](){
            auto def = ThePrototype::AutoBindingsFile::ParseLine("MyScript SomeEditorId");

            AssertThat(def.ScriptName, Equals("MyScript"));
            AssertThat(def.Type, Equals(ThePrototype::BindingDefinitionType::EditorID));
            AssertThat(def.EditorIdMatcher.Type, Equals(ThePrototype::EditorIdMatcherType::Exact));
        ...
        it("ScriptName *SomeEditorId (ends with)", [&](){
            ...
            AssertThat(def.ScriptName, Equals("MyScript"));
            AssertThat(def.Type, Equals(ThePrototype::BindingDefinitionType::EditorID));
            AssertThat(def.EditorIdMatcher.Type, Equals(ThePrototype::EditorIdMatcherType::SuffixMatch));
            AssertThat(def.EditorIdMatcher.Text, Equals("someeditorid")); // Storage is in lowercase
        });
        it("ScriptName *SomeEditorId* (contains)", [&](){
            ...
            AssertThat(def.ScriptName, Equals("MyScript"));
            AssertThat(def.Type, Equals(ThePrototype::BindingDefinitionType::EditorID));
            AssertThat(def.EditorIdMatcher.Type, Equals(ThePrototype::EditorIdMatcherType::PrefixAndSuffixMatch));
            AssertThat(def.EditorIdMatcher.Text, Equals("someeditorid")); // Storage is in lowercase
        });
        it("ScriptName SomeEditorId* (starts with)", [&](){
            ...
            AssertThat(def.ScriptName, Equals("MyScript"));
            AssertThat(def.Type, Equals(ThePrototype::BindingDefinitionType::EditorID));
            AssertThat(def.EditorIdMatcher.Type, Equals(ThePrototype::EditorIdMatcherType::PrefixMatch));
            AssertThat(def.EditorIdMatcher.Text, Equals("someeditorid")); // Storage is in lowercase
        });
        it("ScriptName /.*Sweet.*Roll.*/ (regular expression)", [&](){
            auto def = ThePrototype::AutoBindingsFile::ParseLine("MyScript /.*Sweet.*Roll.*/");

            AssertThat(def.ScriptName, Equals("MyScript"));
            AssertThat(def.Type, Equals(ThePrototype::BindingDefinitionType::EditorID));
            AssertThat(def.EditorIdMatcher.Type, Equals(ThePrototype::EditorIdMatcherType::RegularExpression));
        ...
        it("ScriptName 0x123", [&](){
            auto def = ThePrototype::AutoBindingsFile::ParseLine("PlayerScript 0x14");
        ...
        it("ScriptName 0x123 SomePlugin.esp", [&](){
            auto def = ThePrototype::AutoBindingsFile::ParseLine("PlayerScript 0x14 SomePlugin.esp");
...
//            AssertThat() ...
        ...
        it("ScriptName Prop=TextValue", [&](){
            auto def = ThePrototype::AutoBindingsFile::ParseLine("MyScript Prop=TextValue");
        ...
        it("ScriptName Prop=\"Quoted text value\"", [&](){
            auto def = ThePrototype::AutoBindingsFile::ParseLine(R"(MyScript Prop="Quoted text value")");
        ...
        it("ScriptName *Editor* A=1 B=\"hi there\" C=true z=\"cool with an = sign too\"", [&](){
            auto def = ThePrototype::AutoBindingsFile::ParseLine(R"(MyScript A=1 B="Hi There" C=true D=69 multiline="\nthis\t has special\n characters\n" z=" cool with an = sign too ")");
        ...
        it("ScriptName [BOOK]", [&](){
            auto def = ThePrototype::AutoBindingsFile::ParseLine(R"(MyScript [BOOK])");
        ...
        it("ScriptName [weapon|armor]", [&](){
            auto def = ThePrototype::AutoBindingsFile::ParseLine(R"(MyScript [weapon|armor])");
        ...
        it("Kaboom [Book] TheExplosion=ExplosionShockMass01", [&](){
            auto def = ThePrototype::AutoBindingsFile::ParseLine(R"(Kaboom [Book] TheExplosion=ExplosionShockMass01)");
